...
for dir in fdirs:
    ...
    for f in files:
        ...
        x, y, z = localize_skewed.get_skewed_coords((25, 252, 1272), 0.115, 0.4, 30 * np.pi / 180)
        to_keep, conditions, condition_names, filter_settings = \
            localize_skewed.filter_localizations(fp, ip, (z, y, x), (0.6604, 0.1331), filters["min_dists_um"][0:2],
