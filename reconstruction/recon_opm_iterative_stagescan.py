...
def main(argv):
    ...
    for r_idx in rounds_in_data:
        ...
        for (y_idx, z_idx, ch_BDV_idx) in product(y_in_data,z_in_data,ch_in_BDV):
            ...
            stage_position_filename = Path('r'+str(r_idx).zfill(4)+'_y'+str(y_idx).zfill(4)+'_z'+str(z_idx).zfill(4)+'_ch'+str(ch_idx).zfill(4)+'_stage_positions.csv')
            ...
            data_array = data_io.return_data_numpy(dataset, channel_axis=ch_idx, axis_range=[0,num_images],y_pixels=y_pixels,x_pixels=x_pixels)
