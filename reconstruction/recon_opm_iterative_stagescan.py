...
def main(argv):
        ...
        for (y_idx, z_idx) in product(y_tile_in_data,z_tile_in_data):
            ...
            for (t_idx, ch_BDV_idx) in product(timepoints_in_data, ch_in_BDV):
                ...
                if (save_type==0):
                    ...
                    bdv_writer.append_view(np.fliplr(deskewed_downsample_decon), time=r_idx, channel=ch_BDV_idx, 
                                            tile=tile_idx,
    ...
    if (save_type==1):
        # lazy downsampling of full BDV file
        bdv_writer.create_pyramids(subsamp=((2,2,2), (4, 4, 4), (8, 8, 8), (16,16,16)),
                               blockdim=((32, 128, 128), (32, 128, 128), (32,128,128), (32,128,128)),
                               compression='lzf')
