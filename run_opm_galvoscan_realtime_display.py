...
def main():
    ...
    # run acquisition
    with Acquisition(directory=save_directory, name=save_name, show_display=display_flag, 
                     max_multi_res_index=0, saving_queue_size=5000, image_process_fn=img_process_fn) as acq:
        acq.acquire(events)
    ...
    params = [30,scan_axis_step_um*1000, pixel_size_um*1000]
    deskewed_image = deskew(image_stack,params)

    napari.napari.view_image(deskewed_image, ndisplay=3)
