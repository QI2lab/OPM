...
* /napari-control
  * Run and display a single volume, multicolor galvo mirror scan using the qi2lab OPM on the OPM computer itself.
  * Usage: Setup ROI cropping on camera in Micromanager 2.0. Setup size of galvo sweep (max 275 micrometers for our design), exposure time (galvo stability and laser blanking verified to work down to 1.5 ms exposure time in 256x2304 ROI with OrcaFusion BT), laser lines, and laser powers in Napari.
