...
def main():
    ...
    active_channels = [bool(state_405),bool(state_488),bool(state_561),bool(state_635),bool(state_730)]
    channel_idxs = [0,1,2,3,4]
    do_ind = [0, 1, 2, 3, 4] # digital output line corresponding to each channel
    channels_in_experiment = list(compress(channel_idxs, active_channels))
    n_active_channels = len(channels_in_experiment)
