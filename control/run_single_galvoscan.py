...
def main():
    ...
    channel_states = [False, False, True, True, True] # true -> active, false -> inactive
    channel_powers = [30, 30, 50, 50, 100] # (0 -> 100%)
    ...
    # setup file name
    save_directory=Path('D:/20211117b/')
    save_name = 'bDNA_trial'
